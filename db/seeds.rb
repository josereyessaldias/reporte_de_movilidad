...
Region.create(name: "Región de Arica y Parinacota", order:1, dataone: '568m',datathree: '15', datafive:'...', datasix: '...', dataseven: '34')
Region.create(name: "Región de Tarapacá", order:2, dataone: '653m', datafive:'...', datasix: '...', dataseven: '33')
Region.create(name: "Región de Antofagasta", order:3,  dataone: '831m',datathree: '16', datafive:'...', datasix: '...', dataseven: '60')
Region.create(name: "Región de Copiapó", order:4, dataone: '418m', datafive:'...', datasix: '...', dataseven: '45')
Region.create(name: "Región de Coquimbo", order:5, dataone: '928m',datathree: '18', datafive:'...', datasix: '...', dataseven: '69')
Region.create(name: "Región de Valparaíso", order:6, dataone: '2,3mm',datathree: '107', datafive:'...', datasix: '...', dataseven: '149')
Region.create(name: "Región Metropolitana", order:7,dataone: '18,5mm',datatwo:'1,49',datathree: '378', datafour:'19,6', datafive:'26%', datasix: '346', dataseven: '387')
Region.create(name: "Región de O'Higgins", order:8, datathree: '18', datafive:'...', datasix: '...', dataseven: '130')
Region.create(name: "Región del Maule", order:9, datathree: '13', datafive:'...', datasix: '...', dataseven: '163')
Region.create(name: "Región de Ñuble", order:10)
Region.create(name: "Región del Bio-Bío", order:11, dataone: '1,9mm',datathree: '83', datafive:'...', datasix: '...', dataseven: '237')
Region.create(name: "Región de la Araucanía", order:12, dataone: '1,0mm',datathree: '33', datafive:'...', datasix: '...', dataseven: '155')
Region.create(name: "Región de los Ríos", order:13, dataone: '561m', datathree: '9', datafive:'...', datasix: '...', dataseven: '63')
Region.create(name: "Región de los Lagos", order:14, dataone: '799m', datafive:'...', datasix: '...', dataseven: '117')
