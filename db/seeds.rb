...
Vistum.create(category: "Performance de Transporte Público", order:4, bajada:"La vista Performance del Transporte Público muestra indicadores de la calidad del servicio ofrecido. Para ello se enfoca en indicadores objetivos de operación que inciden directamente en la calidad percibida por los usuarios.", logo:'fas fa-chart-bar')
...
Vistum.create(category: "Seguridad Vial", order:7, bajada:"La seguridad vial se refiere al estudio de los efectos del transporte sobre la salud de las personas, con especial énfasis en los accidentes de tránsito. Aquí se muestra información recolectada por CONASET en donde se detallan accidentes, fatalidades a causa de accidentes y sus causas.",logo:'fas fa-car-crash')
...
Sidebar.create(vistum_id:1, help_title:"Evolutivo Partición Modal", help_text:"Partición modal total del sistema de acuerdo a las Encuestas Origen-Destino de los años indicados.")
...
Sidebar.create(vistum_id:1, help_title:"Generación de viajes por zona", help_text:"Viajes generados por comuna.")
...
Sidebar.create(vistum_id:3, help_title: "Kilómetros recorridos por el sistema", help_text: "Evolución de la cantidad de kilómetros recorridos por los distintos operadores de Transantiago.")
Sidebar.create(vistum_id:3, help_title: "Kilómetros totales operados", help_text: "Evolución de los kilómetros operados en todo el sistema.")

Sidebar.create(vistum_id:4, help_title:"Velocidad promedio en distintos periodos del día", help_text:"Muestra la velocidad comercial promedio de los servicios de Transantiago para tres periodos del día: Día fuera de punta, punta mañana y punta tarde.")
...
Sidebar.create(vistum_id:4, help_title:"Evolutivo de la velocidad de Transantiago por periodo de día", help_text:"Muestra cómo ha evolucionado la velocidad comercial promedio de los buses Red/Transantiago a lo largo de los años en tres distintos periodos de un día laboral.")

Sidebar.create(vistum_id:5, help_title:"Desarrollo Parque Automotriz", help_text:"Evolutivo de la cantidad de vehículos del parque automotriz de la región. Se discrimina por tipo de vehículo.", data_title:"Vehículos totales",data_text:"Parque automotriz del año 2020",data_number:"...")
Sidebar.create(vistum_id:5, help_title:"Autopistas de la Región",help_text:"Muestra las autopistas urbanas de la región.")
Sidebar.create(vistum_id:5, help_title:"Evolutivo Conteo Vehicular",help_text:"Muestra la evolución del total de conteos de vehículos registrados por autopista dividido en la cantidad de pórticos de cada autopista.", data_title:"Tasa de motorización", data_text:"Tasa de motorización año 2016", data_number:"59%")
...
Sidebar.create(vistum_id:6, help_title:"Índice de caminabilidad",help_text:"El Centro de Desarrollo Urbano Sustentable (CEDEUS) elabora un indicador de la caminabilidad ('walkability') por comuna. Éste indica la accesibilidad a través de la caminata los habitantes de cada sector con un rango de 0 a 100.")

Sidebar.create(vistum_id:7, help_title:"Fatalidades en accidentes",help_text:"Se muestra la cantidad de personas afectadas por accidentes, distinguiendo por gravedad.")
Sidebar.create(vistum_id:7, help_title:"Causas y Fatalidades", help_text:"Muestra la proporción de causas que componen a los accidentes, y la gravedad resultante.")
Sidebar.create(vistum_id:7, help_title:"Accidentes Fatales por Zona", help_text:"Muestra la cantidad de personas afectadas por accidentes. Distingue por comuna en la que ocurrió el accidente.")
