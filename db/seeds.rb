...
Region.create(name: "Región Metropolitana", order:7,dataone: '18,5',datatwo:'1,49',datathree: '378', datafour:'19,6', datafive:'27%', datasix: '287,3', dataseven: '387')
...
Sidebar.create(vistum_id:5, help_title:"Desarrollo Parque Automotriz", help_text:"Muestra un evolutivo de la cantidad de vehículos del parque automotriz de la región. Adicionalmente se discrimina por tipo de vehículo, pudiendo entender la preferencia la participación que tiene cada uno.", data_title:"Vehículos totales",data_text:"Parque automotriz del año 2017",data_number:"...")
