...
Vistum.create(category: "Demanda de Transporte Público", order:2, bajada:"Esta vista muestra tendencias de la demanda agregada respecto a operadores de buses de transporte público y líneas de metro. Presenta también los datos obtenidos sobre la evasión en buses.", logo:'fas fa-users')
Vistum.create(category: "Oferta de Transporte Público", order:3, bajada:"Esta vista busca mostrar la oferta de transporte público. Para ellos se exponen cifras respecto a infraestructura, vehículos, frecuencias y paraderos.", logo:'fas fa-bus')
Vistum.create(category: "Performance de Transporte Público", order:4, bajada:"La vista sobre performance del Transporte Público busca mostrar indicadores de la calidad del servicio que se está ofreciendo. Para ello se enfoca en indicadores objetivos de operación que inciden directamente en la calidad percibida por los usuarios.", logo:'fas fa-chart-bar')
Vistum.create(category: "Transporte Privado", order:5, bajada:"Esta vista muestra el estatus del transporte por vehículos motorizados particulares, así como información de las principales autopistas urbanas.", logo:'fas fa-car-alt')
Vistum.create(category: "Transporte No Motorizado", order:6, bajada:"Esta vista muestra el estatus del transporte por vehículos no motorizados (bicicleta y caminata).", logo:'fas fa-bicycle')
Vistum.create(category: "Seguridad Vial", order:7, bajada:"La seguridad vial se refiere al estudio de los efectos del transporte sobre la salud de las personas, especialmente relacionada a los accidentes de tránsito. Aquí se muestra información recolectada por CONASET en donde se detallan accidentes, fatalidades a causa de accidentes y sus causas.",logo:'fas fa-car-crash')
